...
coverage:
	@uv run pytest tests/ -v --cov=src/${name} --cov-report=term-missing

# Generate HTML coverage report
coverage-html:
	@uv run pytest tests/ -v --cov=src/${name} --cov-report=html
...
help:
	...
	@echo "  all          - ${'Sync the environment' if _pure else 'Build/rebuild the extension'} (default)"
	@echo "  sync         - Sync environment (initial setup)"
	@echo "  build        - ${'Sync the editable install' if _pure else 'Rebuild extension after code changes'}"
