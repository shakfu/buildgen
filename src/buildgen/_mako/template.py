...
from buildgen._mako import cache
from buildgen._mako import codegen
from buildgen._mako import compat
from buildgen._mako import exceptions
from buildgen._mako import runtime
from buildgen._mako import util
from buildgen._mako.lexer import Lexer
...
class ModuleInfo:
    ...
    _modules: weakref.WeakValueDictionary[str, "ModuleInfo"] = (
