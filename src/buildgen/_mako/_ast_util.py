...
ALL_SYMBOLS: dict[type, str] = {}
ALL_SYMBOLS.update(BOOLOP_SYMBOLS)  # type: ignore[arg-type]
ALL_SYMBOLS.update(BINOP_SYMBOLS)  # type: ignore[arg-type]
ALL_SYMBOLS.update(CMPOP_SYMBOLS)  # type: ignore[arg-type]
ALL_SYMBOLS.update(UNARYOP_SYMBOLS)  # type: ignore[arg-type]
...
class SourceGenerator(NodeVisitor):
    ...
    @staticmethod
    def _sequence_visit(left: str, right: str):  # type: ignore[misc]
    ...
    @staticmethod
    def _generator_visit(left: str, right: str):  # type: ignore[misc]
        def visit(self, node):  # type: ignore[no-untyped-def]
            self.write(left)
            self.visit(node.elt)
