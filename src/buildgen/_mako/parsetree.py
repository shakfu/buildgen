...
from buildgen._mako import ast
from buildgen._mako import exceptions
from buildgen._mako import filters
...
class NamespaceTag(Tag):
    __keyword__: str | None = "namespace"
