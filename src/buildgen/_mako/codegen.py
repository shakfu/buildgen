...
from buildgen._mako import parsetree
from buildgen._mako import util
from buildgen._mako.pygen import PythonPrinter
...
class _GenerateRenderMethod:
    ...
    def write_toplevel(self):
        ...
        self.printer.writeline("from buildgen._mako import runtime, filters, cache")
